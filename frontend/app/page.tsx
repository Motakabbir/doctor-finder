          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold sm:text-5xl md:text-6xl">
                Find the Right Doctor <span className="text-blue-200">for Your Health</span>
              </h1>
              <p className="mt-3 text-lg text-blue-100 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                Connect with qualified healthcare professionals in your area. Book appointments online, read verified reviews, and get the care you deserve.
              </p>
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <Link
                  href="/doctors"
                  className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-white hover:bg-blue-50 sm:px-8"
                >
                  Find a Doctor
                </Link>
              </div>
...
const features = [
  {
    ...
    description: 'Book appointments with your preferred doctors online in just a few clicks.',
    icon: CalendarIcon,
  },
  {
